...
const Login = () => {
    ...
    return (
        <div>
            ...
            <div className="w-full bg-[url('')] bg-blue-50 bg-cover bg-bottom p-4 rounded-md shadow sm:p-8 text-gray-800 animate__animated animate__zoomIn">
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-2 gap-10">
                    <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                        ...
                        <div className="space-y-2 form-control">
                            ...
                            })} name="password" placeholder="Password" className="w-full px-3 py-2 border rounded-md border-gray-300 bg-gray-50 text-gray-800 focus:border-violet-600" />
                ...
                <p className="text-sm text-center font-medium text-white bg-[#1111115e] w-fit mx-auto p-2 rounded-xl mt-5">Do not have an account?
