...
const Footer = () => {
    return (
        <div className="w-full bg-blue-200 text-[#0684ce] space-y-5 pb-5 text-center">
            <footer>
                <div className="py-10 grid md:grid-cols-2 lg:grid-cols-4 items-center lg:gap-5 space-y-5 lg:space-y-0">
                    <aside className="grid grid-cols-1 gap-1">
                        <Link to={'/'}>
                            <img className="h-10 mx-auto" src="https://i.ibb.co/FzcBGnB/logo.png" alt="TutorSync" />
                        </Link>
                        <p className="font-bold">
                            TutorSync <br />Serving since 2017
                        </p>
            ...
            <footer className="flex flex-col items-center text-center space-y-3">
